    ...
    >
      <div className="sticky top-1/2 left-1/2 min-h-[50rem] min-w-[50rem] -translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] before:border-[2.5rem] before:border-[#CEF144] before:opacity-[var(--opacity-border)]">
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
          className="whitepspace-nowrap text-black min-w-screen absolute top-1/2 left-[calc(-50vw+25rem)] text-[23rem] text-heading"
        >
          Streamlined Trading.
        </motion.p>
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
          className="whitepspace-nowrap text-black min-w-screen absolute top-1/2 left-[calc(-50vw+25rem)] z-[11] text-[23rem] [-webkit-text-stroke:1px_var(--color-heading)]"
        >
          Streamlined Trading.
        </motion.p>
        ...
        <motion.p
          ...
          className="absolute left-1/2 top-1/2 text-[8.8rem] text-center leading-tight text-black"
        >
          Streamlined
          <br />
          Trading.
