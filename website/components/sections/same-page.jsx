    ...
    <section ref={targetRef}>
      <div className="relative h-[800vh]">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            <img src="/main-screen.jpeg" className="h-auto w-full" />
            <motion.img
            ...
            />
            <motion.span
              className="mt-3 block text-2xl text-black"
          ...
          <motion.p
            className="translate-y-centered-offset absolute top-1/2 left-[calc(50%-60rem)] w-[50rem] pl-16 text-2xl leading-tight text-black"
            style={{
        ...
        <motion.p
          ...
          className="translate-y-centered-offset top-1/2 left-[20px] w-[300px] pl-16 text-2xl leading-tight text-black"
        >
          Not only share code,
          <br />
        ...
        <motion.p
          ...
          className="translate-y-centered-offset top-1/2 right-[20px] w-[300px] pr-16 text-xl leading-tight text-black"
        >
