...
export const FeatureCard = ({ gradient, children, id, name, desc, date }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute text-lg left-[10%] top-[15%] w-[80%] transition-transform">
        <div className="text-xl">{name}</div>
        <div className="text-slate-500 text-sm mt-1">{date}</div>

        <div className="mt-3">
          <img src="/left-quotes.png" />
        </div>
